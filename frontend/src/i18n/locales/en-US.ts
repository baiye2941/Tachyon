const enUS = {
  ...
  "toast.undoCancel": "Task cancelled",
  "toast.undoCancelBatch": "Cancelled {count} tasks",
  "toast.undoCancelFailed": "Undo cancel failed: {error}",
  "toast.undoDelete": "Task record deleted",
  "toast.undoDeleteBatch": "Deleted {count} task records",
  "toast.undoDeleteFailed": "Undo delete failed: {error}",
  ...
  "settings.notifications.enabled": "Show system notifications when tasks complete or fail",
  "settings.notifications.enabledHint": "When off, the app won't request notification permission or show any task status notifications.",
  "settings.clipboard.enableWatch": "Clipboard monitor",
  "settings.clipboard.enableWatchHint": "Automatically detect download links in the clipboard and prompt to download (takes effect after saving config; no restart required).",
  "settings.clipboard.restartRequired": "Restart the app to enable clipboard monitoring",
  ...
  "settings.download.rateLimitHint":
    "Leave empty for unlimited. Value is max bytes per second (shared across tasks).",
  "settings.download.proxy": "HTTP/SOCKS proxy",
  "settings.download.proxyPlaceholder": "http://127.0.0.1:7890 or socks5://127.0.0.1:1080",
  "settings.download.proxyHint":
    "Leave empty to use system env (HTTP_PROXY/HTTPS_PROXY/ALL_PROXY). With a proxy enabled, destination DNS is delegated to the proxy (SSRF trust boundary)—use only trusted proxies.",
  "settings.download.ioStrategy": "Disk I/O strategy",
  "settings.download.ioStrategyStandard": "Standard (TokioFile, cross-platform)",
  "settings.download.ioStrategyWinAligned": "WinAligned (Windows NO_BUFFERING)",
  "settings.download.ioStrategyIocp": "IOCP (Windows async)",
  "settings.download.ioStrategyIoUring": "io_uring (Linux 5.4+)",
  "settings.download.ioStrategyHint":
    "Unsupported strategies fall back to Standard. Applies to HTTP writes and BT custom storage.",
  ...
  "settings.magnet.socksProxyUrlHint":
    "Leave empty to auto-detect system proxy. Format: socks5://[user:pass@]host:port. With a proxy enabled, target resolution is delegated to the proxy (SSRF trust boundary)—use only trusted proxies.",
  "settings.magnet.coverageTitle": "BT Proxy Traffic Coverage (Privacy Visibility)",
  "settings.magnet.coveragePeerTcp": "Peer TCP",
  "settings.magnet.coverageHttpTracker": "HTTP(S) Tracker",
  "settings.magnet.coverageUdpTrackerDht": "UDP Tracker / DHT",
  "settings.magnet.coverageUtp": "uTP (UDP-based)",
  "settings.magnet.coverageUpnp": "UPnP (LAN)",
  "settings.magnet.coverageDirect": "Direct (no proxy)",
  "settings.magnet.coverageViaProxy": "Via proxy",
  "settings.magnet.coverageBlocked": "Disabled",
  "settings.magnet.coverageDisabled": "Off",
  "settings.magnet.coverageMayBypass": "May bypass proxy",
  "settings.magnet.coverageHint": "uTP/UPnP are UDP- or LAN-based; SOCKS5 does not proxy UDP and may bypass. Full coverage requires external packet capture to verify.",
  "settings.magnet.coverageSource": "Runtime SOCKS source",
  "settings.magnet.coverageSourceNone": "Disabled",
  "settings.magnet.coverageSourceExplicit": "Explicit config",
  "settings.magnet.coverageSourceEnvironment": "Environment (at session build)",
  "settings.magnet.coveragePendingApply": "Draft prediction — save config and rebuild BT Session to apply",
