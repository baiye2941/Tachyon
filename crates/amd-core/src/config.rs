...
pub const USER_AGENT: &str = "AI Model Downloader/0.1.0";
...
mod tests {
    ...
    fn test_download_config_default() {
        ...
        assert!(config.user_agent.starts_with("AI Model Downloader/"));
        assert!(config.headers.is_empty());
    }

    #[test]
    fn test_user_agent_constant() {
        assert_eq!(USER_AGENT, "AI Model Downloader/0.1.0");
    ...
    fn test_download_config_deserializes_legacy_json() {
        let json = r#"{
            ...
            "userAgent":"AI Model Downloader/Legacy",
            "headers":{}
        }"#;
